...
<div class="Container">
    <div class="container">
        ...
        <?php if ($is_logged_in) : ?>
                ...
                ?>
                <a href="detailProduct.php?productID=<?php echo $mouse['product_ID']?>&fname=<?php echo $fnameShow['fname']?>">
                <div class="product-card">
                    <h3><?php echo $mouse['product_brand']; ?></h3>
                    <img src="<?php echo $mouse['image_path']; ?>" alt="<?php echo $mouse['name_product']; ?>">
                    <h3><?php echo $mouse['name_product']; ?></h3>
                    <p>฿<?php echo $mouse['product_price']; ?></p>
