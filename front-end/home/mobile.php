    ...
    <div class="container">
        ...
        <div class="container-Product-Card">
            <?php if ($is_logged_in) : ?>
                ...
                ?>
                <a href="detailProduct.php?productID=<?php echo $mobile['product_ID']?>&fname=<?php echo $fnameShow['fname']?>">
                <div class="product-card">
                    <h3><?php echo $mobile['product_brand']; ?></h3>
                    <img src="<?php echo $mobile['image_path']; ?>" alt="<?php echo $mobile['name_product']; ?>">
                    <h3><?php echo $mobile['name_product']; ?></h3>
                    <p>฿<?php echo $mobile['product_price']; ?></p>
