    ...
    <?php if ($is_logged_in) : ?>
        ...
        if (!empty($searchResults)) {
            foreach ($searchResults as $product) {
                ?>
                <a href="detailProduct.php?productID=<?php echo $product['product_ID']?>&fname=<?php echo $fnameShow['fname']?>" style='text-decoration:none;'>
                    <div class="product-card">
                        <h3><?php echo $product['product_brand']; ?></h3>
