...
<div class="Container">
    ...
    <div class="product-caption">
        <div class="detail">
            <h1><?php echo $productShow['name_product'] ?></h1>
            <p style='color:#7C7C7C;' class='caption '>แบรนด์:<?php echo $productShow['product_brand'] ?>
                &nbsp;&nbsp; ID:<?php echo $productShow['product_ID'] ?></p>
            <hr>
            <p><?php echo $productShow['product_detail'] ?></p>
            <hr>
            <h1 style='color:red;'>฿<?php echo $productShow['product_price'] ?></h1>
            <?php if ($is_logged_in) : ?>
