  ...
  <body>
      ...
      <div class="container">
          <div class="header">
              <div class="head">
                <h1>ตะกร้าสินค้า(<?php echo count($cartItems); ?>)</h1>
              ...
              <div class="item">
                  ...
                  <div class="info">
                      <h4><?php echo $productShow['name_product']; ?></h4>
                      <p>฿<?php echo $productShow['product_price']; ?></p>
                      <div class="quantity">
          ...
          <div class="body">
              ...
              <div class="total">
                  ...
                  <div class="RealTotal">
                      <h3>ยอดรวมสุทธิ</h3>
                      <span id="realTotal" name='totalPrice'>฿<?php echo $total; ?></span>
                  </div>
              </div>
              <!-- Pay button -->
              <div class="pay-btn">
                <?php if (!empty($cartItems)) : ?>
                    <a href="orderConfirming.php?userID=<?php echo $userID ?>&total=<?php echo $total ?>&fname=<?php echo $fnameShow['fname'] ?>" id="checkout-link">
