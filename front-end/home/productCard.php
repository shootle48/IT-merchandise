    ...
    <div class="container">
        ...
        <div class="container-Product-Card">
            ...
            for ($i = 0; $i < $limit; $i++) {
                ...
                <?php if ($is_logged_in): ?>
                    <a
                        href="detailProduct.php?productID=<?php echo $laptops[$i]['product_ID'] ?>&fname=<?php echo $fnameShow['fname'] ?>">
                        <div class="product-card">
                            <h3>
                                <?php echo $laptops[$i]['product_brand']; ?>
                            </h3>
                            <img src="<?php echo $laptops[$i]['image_path']; ?>"
                                alt="<?php echo $laptops[$i]['name_product']; ?>">
                            <h3>
                                <?php echo $laptops[$i]['name_product']; ?>
                            </h3>
                            <p>฿
                                <?php echo $laptops[$i]['product_price']; ?>
                            </p>
        ...
        <div class="container-Product-Card">
            ...
            for ($i = 0; $i < $limit; $i++) {
                ...
                <?php if ($is_logged_in): ?>
                    <a
                        href="detailProduct.php?productID=<?php echo $mobiles[$i]['product_ID'] ?>&fname=<?php echo $fnameShow['fname'] ?>">
                        <div class="product-card">
                            <h3>
                                <?php echo $mobiles[$i]['product_brand']; ?>
                            </h3>
                            <img src="<?php echo $mobiles[$i]['image_path']; ?>"
                                alt="<?php echo $mobiles[$i]['name_product']; ?>">
                            <h3>
                                <?php echo $mobiles[$i]['name_product']; ?>
                            </h3>
                            <p>฿
                                <?php echo $mobiles[$i]['product_price']; ?>
                            </p>
                            <button>ดูรายละเอียด</button>
                        </div>
                    </a>
        ...
        <div class="container-Product-Card">
            ...
            for ($i = 0; $i < $limit; $i++) {
                ...
                <?php if ($is_logged_in): ?>
                    <a
                        href="detailProduct.php?productID=<?php echo $mouses[$i]['product_ID'] ?>&fname=<?php echo $fnameShow['fname'] ?>">
                        <div class="product-card">
                            <h3>
                                <?php echo $mouses[$i]['product_brand']; ?>
                            </h3>
                            <img src="<?php echo $mouses[$i]['image_path']; ?>"
                                alt="<?php echo $mouses[$i]['name_product']; ?>">
                            <h3>
                                <?php echo $mouses[$i]['name_product']; ?>
                            </h3>
                            <p>฿
                                <?php echo $mouses[$i]['product_price']; ?>
                            </p>
                            <button>ดูรายละเอียด</button>
                        </div>
                    </a>
        ...
        <div class="container-Product-Card">
            ...
            for ($i = 0; $i < $limit; $i++) {
                ...
                <?php if ($is_logged_in): ?>
                    <a
                        href="detailProduct.php?productID=<?php echo $keyboards[$i]['product_ID'] ?>&fname=<?php echo $fnameShow['fname'] ?>">
                        <div class="product-card">
                            <h3>
                                <?php echo $keyboards[$i]['product_brand']; ?>
                            </h3>
                            <img src="<?php echo $keyboards[$i]['image_path']; ?>"
                                alt="<?php echo $keyboards[$i]['name_product']; ?>">
                            <h3>
                                <?php echo $keyboards[$i]['name_product']; ?>
                            </h3>
                            <p>฿
                                <?php echo $keyboards[$i]['product_price']; ?>
                            </p>
                            <button>ดูรายละเอียด</button>
                        </div>
                    </a>
        ...
        <div class="container-Product-Card">
            ...
            for ($i = 0; $i < $limit; $i++) {
                ...
                <?php if ($is_logged_in): ?>
                    <a
                        href="detailProduct.php?productID=<?php echo $headphones[$i]['product_ID'] ?>&fname=<?php echo $fnameShow['fname'] ?>">
                        <div class="product-card">
                            <h3>
                                <?php echo $headphones[$i]['product_brand']; ?>
                            </h3>
                            <img src="<?php echo $headphones[$i]['image_path']; ?>"
                                alt="<?php echo $headphones[$i]['name_product']; ?>">
                            <h3>
                                <?php echo $headphones[$i]['name_product']; ?>
                            </h3>
                            <p>฿
                                <?php echo $headphones[$i]['product_price']; ?>
                            </p>
                            <button>ดูรายละเอียด</button>
                        </div>
                    </a>
