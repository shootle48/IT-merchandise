...
<body>
    <header>
        <div class="catagory">
            <div class="image">
                <?php if ($is_logged_in): ?>
                    <a href="../home/home.php?fname=<?php echo $fnameShow['fname'] ?>"><img src="image/logo.jpg"
                            alt="XD Store" class='logo'></a>
                <?php else: ?>
            ...
            <?php if ($is_logged_in): ?>
                <div class="dropdown">
                    ...
                    <ul class="menu">
                        ...
                        <a href="../home/laptop.php?fname=<?php echo $fnameShow['fname'] ?>">
                            <li>โน๊คบุ๊ค</li>
                        </a>
                        <a href="../home/mobile.php?fname=<?php echo $fnameShow['fname'] ?>">
                            <li>โทรศัพท์</li>
                        </a>
                        <a href="../home/mouse.php?fname=<?php echo $fnameShow['fname'] ?>">
                            <li>เมาส์</li>
                        </a>
                        <a href="../home/keyboard.php?fname=<?php echo $fnameShow['fname'] ?>">
                            <li>คีย์บอร์ด</li>
                        </a>
                        <a href="../home/headphone.php?fname=<?php echo $fnameShow['fname'] ?>">
                            <li>หูฟัง</li>
                        </a>
                        <a href="../home/warranty.php?fname=<?php echo $fnameShow['fname'] ?>">
                            <li>ประกันสินค้า</li>
                        </a>
                    </ul>
                </div>
            ...
            <?php else: ?>
                <div class="dropdown">
                    ...
                    <ul class="menu">
                        ...
                        <a href="../home/laptop.php">
                            <li>โน๊คบุ๊ค</li>
                        </a>
                        <a href="../home/mobile.php">
                            <li>โทรศัพท์</li>
                        </a>
                        <a href="../home/mouse.php">
                            <li>เมาส์</li>
                        </a>
                        <a href="../home/keyboard.php">
                            <li>คีย์บอร์ด</li>
                        </a>
                        <a href="../home/headphone.php">
                            <li>หูฟัง</li>
                        </a>
                        <a href="../home/warranty.php">
                            <li>ประกันสินค้า</li>
                        </a>
                    </ul>
                </div>
        ...
        <div class="search">
            <?php if ($is_logged_in): ?>
                <form action="../home/searchAction.php?fname=<?php echo $fnameShow['fname'] ?>" method="post">
                    ...
                    <button type="submit"
                        style='margin-left:1.2rem; cursor:pointer; background-color:transparent; border:1px solid transparent;'>
        ...
        <div class="login">
            <?php if ($is_logged_in): ?>
                ...
                <div class="dropdownUser">
                    ...
                    <ul class="menuUser">
                        <li><a
                                href="bill.php?fname=<?php echo $fnameShow['fname'] ?>&userID=<?php echo $fnameShow['user_ID'] ?>">ประวัติการสั่งซื้อ</a>
                        </li>
